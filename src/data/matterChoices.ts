export const matterChoices = [
  ...
  { label: 'Prospective Bidders List (PBL)', value: 2, code: 'PBL', channel: 'gcpc' },
  ...
  { label: 'PCCA', value: 6, code: 'PCCA', channel: 'gcpc' },
  ...
  { label: 'Others Form', value: 9, code: 'Others', channel: 'gcpc' },
  { label: 'Revised PCCA', value: 10, code: 'R-PCCA', channel: 'gcp' },
  { label: 'Revised Procurement Plan (RPP)', value: 14, code: 'R-PP', channel: 'gcp' },
  { label: 'Contractual Issue Relating to Payment', value: 11, code: 'CI', channel: 'gcp' },
  { label: 'Contract Progress Report', value: 12, code: 'CPR', channel: 'gcp' },
